declare namespace dstore {
  ...
  export interface ICollection<T> {
    ...
    }): dstore.FetchPromise<T>;
    filter(
      query: string | {} | { (item: T, index: number): boolean }
    ): ICollection<T>;
    forEach(
    ...
    sort(
      property: string | { (a: T, b: T): number },
      descending?: boolean
    ): ICollection<T>;
    track?(): ICollection<T>;
  }
...
declare module 'dojo-dstore/Csv' {
...
declare module 'dojo-dstore/Cache' {
  import Store = require('dojo-dstore/Store');
...
declare module 'dojo-dstore/legacy/StoreAdapter' {
  import Store = require('dojo-dstore/Store');
...
declare module 'dojo-dstore/legacy/DstoreAdapter' {
...
declare module 'dojo-dstore/Memory' {
  import Store = require('dojo-dstore/Store');
...
declare module 'dojo-dstore/charting/StoreSeries' {
  class StoreSeries<T> {
    constructor(
      collection: dstore.ICollection<T> | dstore.ISyncCollection<T>,
      value: any
    );
...
declare module 'dojo-dstore/Tree' {
  import Store = require('dojo-dstore/Store');
...
declare module 'dojo-dstore/SimpleQuery' {
  import Store = require('dojo-dstore/Store');
...
declare module 'dojo-dstore/extensions/RqlQuery' {
  import SimpleQuery = require('dojo-dstore/SimpleQuery');
...
declare module 'dojo-dstore/LocalDB' {
  import Store = require('dojo-dstore/Store');
  ...
  namespace LocalDB {
    ...
    export interface IDBConfig {
      stores: Record<string, IDBStoreConfig>;
      version: number;
    }
...
declare module 'dojo-dstore/db/IndexedDB' {
  import LocalDB = require('dojo-dstore/LocalDB');
...
declare module 'dojo-dstore/db/SQL' {
  import LocalDB = require('dojo-dstore/LocalDB');
...
declare module 'dojo-dstore/db/LocalStorage' {
  import LocalDB = require('dojo-dstore/LocalDB');
...
declare module 'dojo-dstore/Trackable' {
  class Trackable<T> {
    currentRange: any[];
...
declare module 'dojo-dstore/Request' {
  import Store = require('dojo-dstore/Store');
...
declare module 'dojo-dstore/RequestMemory' {
  import Request = require('dojo-dstore/Request');
  import Cache = require('dojo-dstore/Cache');
...
declare module 'dojo-dstore/Rest' {
  import Request = require('dojo-dstore/Request');
...
declare module 'dojo-dstore/Store' {
  ...
  class Store<T> extends decl.Base implements dstore.ICollection<T> {
    ...
    on(
      eventName: string,
      listener: (event: dstore.ChangeEvent<T>) => void
    ): IHandle;
